    ...
    public partial class init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyNearbyPlaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyNearbyPlaces_NearbyPlaces_NearbyPlaceId",
                        column: x => x.NearbyPlaceId,
                        principalTable: "NearbyPlaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyNearbyPlaces_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyNearbyPlaces_NearbyPlaceId",
                table: "PropertyNearbyPlaces",
                column: "NearbyPlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyNearbyPlaces_PropertyId",
                table: "PropertyNearbyPlaces",
                column: "PropertyId");
        }
